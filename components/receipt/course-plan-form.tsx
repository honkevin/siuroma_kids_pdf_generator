// components/receipt/course-plan-form.tsx
...
import { FormDataType } from "@/components/receipt/receipt-form"; // Reuse type
...
export function CoursePlanForm({ formData, setFormData }: CoursePlanFormProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Top strip: Simplified for Course Plan */}
...
// Reusable fields (Same as ReceiptForm)
